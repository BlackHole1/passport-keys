...
| Passport Keys application | `docs/passport-keys.md`, `main/main.c`, `main/pk_app.h`, the nearest `main/pk_*.c` implementation |
...
| CI or release | `../.github/workflows/` and `../docs/release.md` in the passport-keys repository root; `docs/development/ci/CI-*.md` only describes the upstream FoloToy/ai-passport workflows |
